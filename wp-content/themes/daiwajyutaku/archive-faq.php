    ...
    <main class="infor">
        <section class="infor-banner">
            <div class="infor-banner__image">
                <img class="infor-banner__img" src="<?php echo get_template_directory_uri(); ?>/assets/img/column/faq-banner.jpg" alt="賃貸管理トラブル集">
            </div>
            <div class="infor-banner__box">
                <h2 class="infor-banner__title">FAQ<span class="infor-banner__caption">賃貸管理トラブル集</span></h2>
            </div>
        </section>
