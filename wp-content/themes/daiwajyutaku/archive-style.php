...
<main class="style">
    ...
    <section class="style-content l-container">
                    ...
                    <div class="style-content__item">
                        ...
                        <div class="style-content__image">
                            <?php if( get_field('image') ): ?>
                                <img class="style-content__img" src="<?php echo get_field('image')['url']; ?>" alt="<?php the_title(); ?>">
                            <?php else : ?> 
                                <img class="style-content__img" src="<?php echo get_template_directory_uri(); ?>/assets/img/content/no-image.png" alt="no image available">
                            <?php endif; ?>	                       
