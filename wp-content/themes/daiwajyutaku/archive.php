...
<main class="infor">
    <section class="infor-banner">
        <div class="infor-banner__image">
            <img class="infor-banner__img" src="<?php echo get_template_directory_uri(); ?>/assets/img/infor/infor-banner.jpg" alt="大和住宅について">
        </div>
        <div class="infor-banner__box">
            <h2 class="infor-banner__title"> Information<span class="infor-banner__caption">お知らせ</span></h2>
        </div>
    </section>
